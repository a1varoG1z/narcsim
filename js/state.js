...
import { defaultConceptionDialogue, defaultPoachDialogue, defaultInformantDialogue } from "./dialogues.js";
...
export function buildGameFromEra(eraData, options) {
  ...
  return {
    ...
    dialogueTrees: { conception: defaultConceptionDialogue(), poach: defaultPoachDialogue(), informant: defaultInformantDialogue() },
    playerCartelId,
    playerCharacterId,
